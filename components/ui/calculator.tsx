...
export default function Calculator() {
    ...
    const buttonClass = "bg-sky-950 text-white text-xl rounded-full hover:bg-sky-800 active:bg-sky-900";
    const orangeButtonClass = "bg-orange-500 text-white text-xl rounded-full hover:bg-orange-600 active:bg-orange-500";

    return (
        <div className="flex flex-col items-center justify-center h-screen bg-gradient-to-br from-blue-100 via-blue-75 to-blue-300">
            <Card className="w-80 p-4 bg-red rounded-lg shadow-2xl shadow-gray-600">
